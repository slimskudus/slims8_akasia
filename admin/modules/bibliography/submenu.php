...
$menu[] = array(__('Cetak Label Barcode'), MWB.'bibliography/label_barcode_generator_s.php', __('Print Document Labels'));
$menu[] = array(__('Cetak Label Barcode Warna'), MWB.'bibliography/label_barcode_generator_warna_s.php', __('Cetak Label Barcode Warna'));
