...
<div class="menuBoxInner printIcon">
  ...
  <div class="sub_section">
	  <div class="btn-group">
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/label_barcode_generator_warna_s.php?action=clear" class="notAJAX btn btn-default"><i class="glyphicon glyphicon-trash"></i>&nbsp;<?php echo __('Clear Print Queue'); ?></a>
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/label_barcode_generator_warna_s.php?action=print" class="notAJAX btn btn-success"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Print Barcodes for Selected Data');?></a>
    ...
    <form name="search" action="<?php echo MWB; ?>bibliography/label_barcode_generator_warna_s.php" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?> :
