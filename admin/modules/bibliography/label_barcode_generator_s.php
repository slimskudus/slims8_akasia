...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
  ...
  foreach ($chunked_barcode_arrays as $barcode_rows) {
    ...
    foreach ($barcode_rows as $barcode) {
       ...
       $html_str .= '</div>'."\n";
       $html_str .=  '<div class="header" style="background-color:#FFF;color: #000;text-transform: uppercase;font-weight: bold;z-index:-2;">'.($sysconf['print']['barcode']['barcode_header_text']?$sysconf['print']['barcode']['barcode_header_text']:$sysconf['library_name']).'</div>'."\n";
...
<div class="menuBoxInner printIcon">
  ...
  <div class="sub_section">
	  <div class="btn-group">
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/label_barcode_generator_s.php?action=clear" class="notAJAX btn btn-default"><i class="glyphicon glyphicon-trash"></i>&nbsp;<?php echo __('Clear Print Queue'); ?></a>
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/label_barcode_generator_s.php?action=print" class="notAJAX btn btn-success"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Print Barcodes for Selected Data');?></a>
    ...
    <form name="search" action="<?php echo MWB; ?>bibliography/label_barcode_generator_s.php" id="search" method="get" style="display: inline;"><?php echo __('Search'); ?> :
